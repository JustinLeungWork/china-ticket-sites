...
module.exports = async (req, res) => {
  ...
  let visitors = [];
  try { visitors = JSON.parse(m.visitors || '[]').map(v => ({ name: v.n, passportNumber: v.p, nationality: v.nat, dateOfBirth: v.dob, type: v.t })); } catch (_) {}
